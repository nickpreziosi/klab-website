/**
 * Static staff data (names, images, emails). Position and bio come from translations (companyStaff.employees.* / companyStaff.board.*).
 */
...
export const EMPLOYEES_STATIC = [
  ...
  {
    key: "nickSchwartz" as const,
    name: "Nick Schwartz",
    image: "/images/people/nick-schwartz.webp",
    imageLight: "/images/people/nick-schwartz.webp",
    imageDark: "/images/people/nick-schwartz-black.webp",
    email: "nick@k-lab.ai",
  },
  {
    key: "tomasGuzman" as const,
    name: "Tomás Guzmán",
...
export const BOARD_STATIC = [
  ...
  {
    key: "alessandroCiacchini" as const,
