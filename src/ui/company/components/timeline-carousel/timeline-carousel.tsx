...
const timelineData: TimelineEvent[] = [
  ...
  },
  {
    quarter: "Q1",
    year: "2023",
    milestones: ["WorKEO reaches over $1B of transactions in multiple geographies"],
  },
  {
    quarter: "Q1",
    year: "2024",
          ...
          <div className={styles.embla} ref={emblaRef}>
            <div className={styles.emblaContainer}>
              {timelineData.map((event, index) => (
                <div key={`${event.quarter}-${event.year}`} className={styles.emblaSlide}>
                  <div className={styles.timelineItem}>
                    <div className={styles.timelineDot} />
                    {index < timelineData.length - 1 && <div className={styles.timelineLine} />}
