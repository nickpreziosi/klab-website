...
const MANIFESTO_ITEMS = [
  {
    text: "In code we trust. In people we invest.",
    highlights: ["code we trust", "people we invest"],
  },
  {
    text: "Zero friction. Zero fraud. Zero excuses.",
    highlights: ["Zero friction", "Zero fraud", "Zero excuses"],
  },
  ...
  {
    text: "Success is only success if it's shared.",
    highlights: ["success is only success if it's shared"],
  },
  ...
  {
    text: "Defending the future from the friction of the past.",
    highlights: ["Defending the future from the friction of the past."],
  },
  {
    text: "Infrastructure for the unhackable.",
    highlights: ["Infrastructure for the unhackable."],
  },
  {
    text: "The more we create, the more we give.",
    highlights: ["The more we create", "the more we give"],
  },
];
