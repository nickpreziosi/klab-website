        ...
        <div className={styles.container}>
          ...
          <div className={styles.newsletter}>
            <div className={styles.newsletterContent}>
              ...
              <div className={styles.newsletterText}>
                ...
                <p className={styles.newsletterSubheading}>Subscribe for KLab updates.</p>
              </div>
            </div>
            <form onSubmit={handleSubmit(handleSubscribe)} className={styles.subscribeForm}>
              <div className={styles.emailInputWrapper}>
                <input
                  ...
                  className={`${styles.emailInput} ${errors.email ? styles.emailInputError : ""}`}
          ...
          <div className={styles.legal}>
            ...
            <p className={styles.legalText}>
              ...
              applicable privacy laws. For questions, contact{" "}
              <a href="mailto:privacyprotection@keoworld.com" className={styles.legalLink}>
