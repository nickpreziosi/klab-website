...
export const Logo = ({
  ...
  const getSizeClass = () => {
    if (fit === "fit-content") {
      ...
      return styles[`fit${fit.charAt(0).toUpperCase()}${fit.slice(1)}` as keyof typeof styles];
    } else {
  ...
  return (
    <MotionComponent tabIndex={-1} inert aria-hidden className={containerClasses} {...motionProps}>
