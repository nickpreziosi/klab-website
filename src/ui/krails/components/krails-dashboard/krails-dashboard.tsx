    ...
    <div tabIndex={-1} aria-hidden="true" role="presentation" className={styles.dashboardContainer}>
      {(() => {
        ...
        const stackProps = skipAnimation
          ? { className: styles.dashboardStack, style: { transform: skipStackTransform } }
          : {
        ...
        return (
          <StackWrapper {...stackProps}>
            ...
            <motion.div
              ...
              initial={
                skipAnimation
                  ? panelOneVariants[screenSize].animate
                  : panelOneVariants[screenSize].initial
              }
              ...
              viewport={skipAnimation ? undefined : { once: true, amount: 0.45 }}
              style={{ zIndex: 1 }}
            ...
            <motion.div
              ...
              initial={
                skipAnimation
                  ? panelTwoVariants[screenSize].animate
                  : panelTwoVariants[screenSize].initial
              }
            ...
            <motion.div
              ...
              initial={
                skipAnimation
                  ? panelThreeVariants[screenSize].animate
                  : panelThreeVariants[screenSize].initial
              }
