...
export default function KRailsDashboard() {
  ...
  useEffect(() => {
    ...
    const updateScreenSize = () => {
      ...
      resizeTimeout = setTimeout(() => {
        ...
        const newSize =
          width <= 500 ? "mobile" : width <= 1024 ? "tablet" : width <= 1600 ? "desktop" : "large";
  ...
  return (
    <motion.div
      animate={{
        transform: screenSize !== "mobile" ? "translateY(-80px)" : "translateY(0)",
      }}
      tabIndex={-1}
      aria-hidden="true"
      role="presentation"
              ...
              <div className={styles.responseList}>
                <div className={styles.responseItem}>
                  ...
                  <div className={styles.responseContent}>
                    <p className={styles.responseTitle}>Health check is successful</p>
                  </div>
                </div>
                <div className={styles.responseItem}>
                  <span className={styles.statusBadge}>
                  ...
                  <div className={styles.responseContent}>
                    <p className={styles.responseTitle}>Health check is not ok</p>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div className={styles.langTabContent}>
                    ...
                    >
                      <defs>
                        ...
                        <linearGradient id="o" x1="56.57%" x2="3.105%" y1="101.717%" y2="11.993%">
                        ...
                        <linearGradient id="p" x1="30.87%" x2="92.471%" y1="35.599%" y2="100.694%">
                      ...
                      />
                      <path fill="url(#g)" d="M214.191.99 170.8 24.97 143.424.669l70.767.322z" />
                      <path fill="url(#h)" d="m0 203.372 18.177-33.151-14.704-39.494L0 203.372z" />
                      <path
                        fill="#FFF"
              ...
              <div className={styles.codeWithGutter}>
                ...
                <pre className={styles.codeBlock}>
                  <code>
                    ...
                    <span className={styles.codeString}>&quot;accept&quot;</span>:{" "}
                    <span className={styles.codeString}>&quot;application json&quot;</span>
                    {"}"}
                    {"\n\n"}
              ...
              <div className={styles.codeWithGutter}>
                <pre className={styles.codeBlock}>
                  <code>
                    ...
                    <span className={styles.codeString}>&quot;gitCommitHash&quot;</span>:{" "}
                    <span className={styles.codeString}>
