      ...
      <div className={styles.container}>
        ...
        >
          ...
          >
            ...
            <div className={styles.logoWrapper}>
              <Link
                aria-label={t("goToWebsite", { name: "EVM" })}
                href="https://ethereum.org/en/developers/docs/evm/"
                className={`${styles.logo} ${styles.evmLockup}`}
              >
                <span className={styles.ethereumLogoClip} aria-hidden>
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    src="/logos/ethereum-diamond.png"
                    alt=""
                    width={150}
                    height={150}
                ...
                <span className={`${styles.evmLabel} ${inter.className}`}>EVM</span>
              </Link>
            </div>
