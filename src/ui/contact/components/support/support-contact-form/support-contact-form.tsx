 ...
 */
export function SupportContactForm({ skipAnimation = false }: SupportContactFormProps = {}) {
  ...
  return (
    ...
    >
      ...
      >
        <a className={styles.headerEmailLink} href="mailto:support@k-lab.ai">
