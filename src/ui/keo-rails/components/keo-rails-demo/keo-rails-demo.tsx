...
import KeoRailsPhoneSlideshow from "@/ui/keo-rails/components/keo-rails-phone-slideshow/keo-rails-phone-slideshow";
        ...
        <div className={styles.content}>
          ...
          <div className={styles.leftColumn}>
            ...
            <div className={styles.textBlock}>
              ...
              <p className={styles.description}>
                With fully customizable, self-custody digital wallets, you reclaim control. Execute
                domestic and cross-border payments with zero friction, and seamlessly make domestic
                and cross-border payments via stablecoins and move funds between traditional bank
            ...
            <div className={styles.textBlock}>
              ...
              <p className={styles.description}>
                KEO Rails ensures enterprise-grade payment security through cutting edge
            ...
            <div className={styles.textBlock}>
              ...
              <p className={styles.description}>
                ...
                payments. We integrated the ability to finance B2B payments directly into the rail.
                It&apos;s instant leverage for the lenders who have the vision (op 2 courage) to
                move at our speed.
              </p>
            </div>
