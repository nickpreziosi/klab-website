    ...
    <main className={styles.main}>
      <div className={styles.container}>
        <div className={styles.content}>
          <p className={styles.label}>KEO LITEPAPER</p>

          <h1 className={styles.heading}>
            Explore how KEO reimagines blockchain payments with stability and
            predictability at its core
          </h1>

          <p className={styles.description}>
            KEO is a purpose-built, EVM-compatible Layer-1 blockchain advancing
            ...
            capital markets, KEO serves as a foundational settlement layer for
