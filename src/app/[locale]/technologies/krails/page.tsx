...
export default async function KRailsPage({ params }: Props) {
  ...
  const translations = {
    ...
    capDashTitle: t("capDashTitle"),
    capDashBody: t("capDashBody"),
    capDashAlt: t("capDashAlt"),
    capVerifiedTitle: t("capVerifiedTitle"),
    capVerifiedBody: t("capVerifiedBody"),
    capProgramTitle: t("capProgramTitle"),
    capProgramBody: t("capProgramBody"),
    capProgramAlt: t("capProgramAlt"),
    capErrorsTitle: t("capErrorsTitle"),
    capErrorsBody: t("capErrorsBody"),
    capErrorsAlt: t("capErrorsAlt"),
    capRailsTitle: t("capRailsTitle"),
    capRailsBody: t("capRailsBody"),
    capRailsAlt: t("capRailsAlt"),
    capLoopTitle: t("capLoopTitle"),
    capLoopBody: t("capLoopBody"),
    capLoopAlt: t("capLoopAlt"),
