...
import styles from "./keo-rails-video-player.module.css";
import Image from "next/image";

interface KeoRailsVideoPlayerProps {
  videoUrl?: string;
  posterUrl?: string;
}

export default function KeoRailsVideoPlayer({
  videoUrl,
  posterUrl,
}: KeoRailsVideoPlayerProps) {
