        ...
        <div className={styles.container}>
          ...
          <div className={styles.cardsGrid}>
            <ContactLink
              ...
              title="Sales"
              description="Interested in learning more about KEO's products and services? Our sales team is here to answer your questions, provide personalized demos, and help you find the perfect solution for your business needs."
              href="/contact/sales"
            ...
            <ContactLink
              ...
              title="Careers"
              description="Excited about shaping the future of financial technology? Reach out to our careers team to explore opportunities to join KEO and contribute to our mission."
